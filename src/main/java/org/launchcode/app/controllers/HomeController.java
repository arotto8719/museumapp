...
//        model.addAttribute("images", "Images");
    ...
    public String processEditForm(Model model, @PathVariable int postId, @RequestParam(value = "name") String name, @RequestParam(value = "location") String location, @RequestParam(value = "description") String description, Error error) {
        Artifact thePost = artifactRepository.findById(postId).get();
